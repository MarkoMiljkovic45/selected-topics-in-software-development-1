...
public class StringReader {
    ...
    /**
     * Used to initialize the StringReader object
     *
     ...
     */
    public StringReader(char[] text, int startIndex, char escapeCharacter, List<Character> escapableCharacters) {
        this.text = text;
     ...
     */
    public StringReader(char[] text, int startIndex, char escapeCharacter) {
     ...
     * @param startIndex The starting index at which reading will begin
     */
    public StringReader(char[] text, int startIndex) {
     ...
     * @param escapableCharacters A list of escapable characters
     */
    public StringReader(String text, int startIndex, char escapeCharacter, List<Character> escapableCharacters) {
     ...
     * @param escapeCharacter A list of escapable characters
     */
    public StringReader(String text, int startIndex, char escapeCharacter) {
     ...
     * @param startIndex The starting index at which reading will begin
     */
    public StringReader(String text, int startIndex) {
